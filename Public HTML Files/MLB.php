...
<?php
	...
	if($_SESSION["logged_in"] != 1){
		...
		$sql = "SELECT mlb_wins FROM user WHERE email =" . "\"$email\"" . ";"; 
		$host = "";
		$user = "";
		$pass = "";
		$db = "";
...
<body>
	<div class="container-fluid">
		...
		<div class="body">
		<h3>Current MLB Contests:</h3>
		<?php echo $email; echo "<br> Number of MLB wins: "; echo $wins;?></div>
		<br>
		<div class="body">
			<div class="SetWinner">
				<?php
				    $_SESSION['sport'] = 'mlb';
						...
						$currDate = date("Y-m-d");
						$sql = "SELECT * FROM contests WHERE sport = 'MLB' and end_date > '".$currDate."'";
