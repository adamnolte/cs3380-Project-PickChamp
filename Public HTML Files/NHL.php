...
<?php
	...
	if($_SESSION["logged_in"] != 1){
		...
		$sql = "SELECT nhl_wins FROM user WHERE email =" . "\"$email\"" . ";"; 
		$host = "";
		$user = "";
		$pass = "";
		$db = "";
...
<body>
	<div class="container-fluid">
		...
		<div class="body">
		<h3>Current NHL Contests:</h3>
		<?php echo $email; echo "<br> Number of NHL wins: "; echo $wins;?> 
		</div>
		<br>
		<div class="body">
			<div class="SetWinner">
				<?php
				    $_SESSION['sport'] = 'nhl';
						...
						$currDate = date("Y-m-d");
						$sql = "SELECT * FROM contests WHERE sport = 'NHL' and end_date > '".$currDate."'";
